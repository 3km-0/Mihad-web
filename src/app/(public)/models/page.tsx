...
export const metadata: Metadata = {
  ...
  description: 'Browse Saudi prefab models and request quotes with clear scope notes.',
  ...
  return (
    <PublicPageShell>
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="Models" title="Popular prefab models" titleAr="نماذج جاهزة شائعة" body="Use model pages to understand size, scope, delivery regions, and supplier fit before requesting a quote." />
