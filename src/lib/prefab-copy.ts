...
export const prefabCopy = {
  nav: {
    ...
    getMatched: { ar: 'احسب مشروعك الجاهز', en: 'Estimate your prefab project' },
    whatsapp: { ar: 'واتساب', en: 'WhatsApp' },
    request: { ar: 'حاسبة', en: 'Calculator' },
  },
  rfq: {
    steps: {
    ...
    headerEyebrow: { ar: 'موجز مشروع جاهز', en: 'Prefab project brief' },
    headerTitle: { ar: 'خلّنا نحفظ النطاق ونكمل النواقص.', en: 'Save the scope and complete the gaps.' },
    successTitle: { ar: 'حفظنا موجز المشروع.', en: 'Your project brief has been saved.' },
    successBody: {
      ar: 'فريق مهاد بيراجع النطاق، النواقص، والأرقام قبل أي تواصل مع مورد أو مالك أرض.',
      en: 'Mihad will review the scope, gaps, and economics before any supplier or landowner outreach.',
    },
    ...
    send: { ar: 'حفظ موجز المشروع', en: 'Save project brief' },
