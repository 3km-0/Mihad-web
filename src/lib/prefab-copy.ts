...
export const prefabCopy = {
  nav: {
    ...
    getMatched: { ar: 'ابدأ طلبك', en: 'Get matched' },
    whatsapp: { ar: 'واتساب', en: 'WhatsApp' },
    request: { ar: 'طلب عرض', en: 'Request' },
  },
  rfq: {
    steps: {
      ar: ['نوع المشروع', 'الموقع والأرض', 'المتطلبات', 'الميزانية والوقت', 'نطاق المساعدة', 'التواصل'],
      en: ['Project type', 'Location and land', 'Requirements', 'Budget and timeline', 'Scope help', 'Contact'],
    },
    headerEyebrow: { ar: 'اطلب عروض أسعار من موردين مناسبين', en: 'Request prefab quotes from verified suppliers' },
    headerTitle: { ar: 'خلّنا نعرف تفاصيل مشروعك.', en: 'Tell us about your project.' },
    successTitle: { ar: 'وصلنا طلبك.', en: 'Your request has been received.' },
    successBody: {
      ar: 'فريق مهاد بيراجع تفاصيل المشروع ويربط الطلب بالموردين الأنسب.',
      en: 'Mihad will review your project details and match the RFQ with suitable prefab suppliers.',
    },
    reference: { ar: 'رقم الطلب', en: 'RFQ reference' },
